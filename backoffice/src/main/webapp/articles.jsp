...
<html lang="es">
    ...
    <body>
        <div class="topbar">
            ...
            <span class="topbar_userinfo" style="">Jarein </span>
        ...
        <header class="cd-main-header header">
            <a class="cd-logo" href="#0">
                <h1 class="store-branding-logo">                   
                    <img src="assets/images/logo-electrosa-retro.png" />        
        ...
        <section>
                ...
                <form action="articles.jsp">
                    <fieldset>
                        <div>
                            ...
                            <input type="text" name="q" id="cd-search" value="<%= request.getParameter("q") != null ? request.getParameter("q") : ""%>">
                        </div>
                        <div>
            ...
            <p>
                Búsqueda de <span style="font-weight: bold;">'<%= request.getParameter("q")%>'</span> en todo el catálogo de
                productos:
            </p>
